...
odpoved = reading[a][1]
rozmery = [para.obrazovka_x/100 + para.obrazovka_x/40, para.obrazovka_x/4 + para.obrazovka_x/40, para.vrchol_x + para.obrazovka_x/40, para.obrazovka_x - para.obrazovka_x/100 - 200 - para.obrazovka_x/40]
...
button1 = buttons.Buttons((0, 255, 0), rozmery[0], 850, 200, 100, odpoved)
button2 = buttons.Buttons((0, 255, 0), rozmery[1], 850, 200, 100, spatne[0])
button3 = buttons.Buttons((0, 255, 0), rozmery[2], 850, 200, 100, spatne[1])
button4 = buttons.Buttons((0, 255, 0), rozmery[3], 850, 200, 100, spatne[2])
question = buttons.Buttons((255, 255, 255), para.obrazovka_x/4, 760, 500, 45, otazka)
